...
| `{{HIGH_RISK_AREAS}}` | Bereiche mit verschaerften Gates | siehe [internal-repo] |
...
| `{{PROJECT_EXTRA_DOD}}` | zusaetzliche DoD-Zeilen | siehe [internal-repo] |
| `{{EXTRA_CONSTRAINTS}}` | projektspezifische /goal-Constraints | siehe [internal-repo] |
