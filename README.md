...
Extracted and generalized from the internal PeakShare / Colibrie migration workflow (July 2026), then rebuilt around the config-driven model so it could travel to any repo. Zero runtime dependencies, by design.
